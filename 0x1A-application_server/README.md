...
* **0. Set up development with Python**
  * In this task, I configured the file `web_flask/0-hello_route.py` from my
  [AirBnB_clone_v2]to serve content
...
* **6. Deploy it**
  * [gunicorn.conf]: Configuration file for an Upstart script that starts a
...
* **7. No service interruption**
  * [4-reload_gunicorn_no_downtime]: Bash script that gracefully
  reloads Gunicorn.
